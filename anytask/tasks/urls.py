...
urlpatterns = [
    url(r'^create/(?P<course_id>\d+)$', views.task_create_page, name='tasks.views.task_create_page'),
    url(r'^import/(?P<course_id>\d+)$', views.task_import_page, name='tasks.views.task_import_page'),
    url(r'^contest_import/(?P<course_id>\d+)$', views.contest_import_page),
    url(r'^edit/(?P<task_id>\d+)$', views.task_edit_page, name='tasks.views.task_edit_page'),
